 ...
 */
export const testDeltaBug = (_tc: t.TestCase) => {
    const initialDelta = [{
        attributes: {
 ...
 * @param {t.TestCase} _tc
 */
export const testDeltaBug2 = (_tc: t.TestCase) => {
 ...
 * @param {t.TestCase} tc
 */
export const testDeltaAfterConcurrentFormatting = (tc: t.TestCase) => {
 ...
 * @param {t.TestCase} _tc
 */
export const testMultilineFormat = (_tc: t.TestCase) => {
    const ydoc = new Y.Doc()
 ...
 * @param {t.TestCase} _tc
 */
export const testNotMergeEmptyLinesFormat = (_tc: t.TestCase) => {
    const ydoc = new Y.Doc()
    const testText = ydoc.getText('test')
    testText.applyDelta([
        { insert: 'Text' },
 ...
 * @param {t.TestCase} _tc
 */
export const testPreserveAttributesThroughDelete = (_tc: t.TestCase) => {
    const ydoc = new Y.Doc()
    const testText = ydoc.getText('test')
    testText.applyDelta([
        { insert: 'Text' },
 ...
 * @param {t.TestCase} tc
 */
export const testGetDeltaWithEmbeds = (tc: t.TestCase) => {
 ...
 * @param {t.TestCase} tc
 */
export const testTypesAsEmbed = (tc: t.TestCase) => {
    const { text0, text1, testConnector } = init(tc, { users: 2 })
    text0.applyDelta([{
 ...
 * @param {t.TestCase} tc
 */
export const testSnapshot = (tc: t.TestCase) => {
    const { text0 } = init(tc, { users: 1 })
    ...
    state2Diff.forEach((v: { attributes: { ychange: { user: any } } }) => {
 ...
 * @param {t.TestCase} tc
 */
export const testSnapshotDeleteAfter = (tc: t.TestCase) => {
    const { text0 } = init(tc, { users: 1 })
    const doc0 = text0.doc as Y.Doc
    doc0.gc = false
    text0.applyDelta([{
 ...
 * @param {t.TestCase} tc
 */
export const testToJson = (tc: t.TestCase) => {
    const { text0 } = init(tc, { users: 1 })
    text0.insert(0, 'abc', { bold: true })
 ...
 * @param {t.TestCase} tc
 */
export const testToDeltaEmbedAttributes = (tc: t.TestCase) => {
    const { text0 } = init(tc, { users: 1 })
 ...
 * @param {t.TestCase} tc
 */
export const testToDeltaEmbedNoAttributes = (tc: t.TestCase) => {
    const { text0 } = init(tc, { users: 1 })
    text0.insert(0, 'ab', { bold: true })
 ...
 * @param {t.TestCase} tc
 */
export const testFormattingRemoved = (tc: t.TestCase) => {
    const { text0 } = init(tc, { users: 1 })
    text0.insert(0, 'ab', { bold: true })
    text0.delete(0, 2)
 ...
 * @param {t.TestCase} tc
 */
export const testFormattingRemovedInMidText = (tc: t.TestCase) => {
    const { text0 } = init(tc, { users: 1 })
    text0.insert(0, '1234')
 ...
 * @param {t.TestCase} tc
 */
export const testFormattingDeltaUnnecessaryAttributeChange = (tc: t.TestCase) => {
    const { text0, text1, testConnector } = init(tc, { users: 2 })
    text0.insert(0, '\n', {
 ...
 * @param {t.TestCase} tc
 */
export const testInsertAndDeleteAtRandomPositions = (tc: t.TestCase) => {
    const N = 100000
    const { text0 } = init(tc, { users: 1 })
    const gen = tc.prng
 ...
 * @param {t.TestCase} tc
 */
export const testAppendChars = (tc: t.TestCase) => {
    const N = 10000
    const { text0 } = init(tc, { users: 1 })
...
const id = Y.new ID(0, 0)
const c = new Y.ContentString('a')

/**
 * @param {t.TestCase} _tc
 */
export const testBestCase = (_tc: t.TestCase) => {
    ...
    t.measureTime('time to create two million items in the best case', () => {
        ...
        for (let i = 0; i < N; i++) {
             ...
             * @type {Y.Item}
             */
            const n: Y.Item = new Y.Item(Y.new ID(0, 0), null, null, null, null, null, null, c)
            // items.push(n)
            items[i] = n
            n.right = prevItem
 ...
 * @param {t.TestCase} _tc
 */
export const testLargeFragmentedDocument = (_tc: t.TestCase) => {
    ...
    ;(() => {
        ...
        t.describe('Document size:', update!.byteLength as any) // t.describe's typing miss
    })()
    ;(() => {
 ...
 * @param {t.TestCase} _tc
 */
export const testIncrementalUpdatesPerformanceOnLargeFragmentedDocument = (_tc: t.TestCase) => {
    const itemsToInsert = largeDocumentSize
 ...
 * @param {t.TestCase} tc
 */
export const testSplitSurrogateCharacter = (tc: t.TestCase) => {
    {
        const { users, text0 } = init(tc, { users: 2 })
 ...
 * @param {t.TestCase} tc
 */
export const testSearchMarkerBug1 = (tc: t.TestCase) => {
    const { users, text0, text1, testConnector } = init(tc, { users: 2 })

    users[0].on('update', (update: Uint8Array) => {
        users[0].transact(() => {
 ...
 * @param {t.TestCase} _tc
 */
export const testFormattingBug = async (_tc: t.TestCase) => {
    const ydoc1 = new Y.Doc()
 ...
 * @param {t.TestCase} _tc
 */
export const testDeleteFormatting = (_tc: t.TestCase) => {
    const doc = new Y.Doc()
...
const textChanges: Array<((arg0: any, arg1: prng.PRNG) => void)> = [
     ...
     * @param {prng.PRNG} gen
     */
    (y: Y.Doc, gen: prng.PRNG) => { // insert text
     ...
     * @param {prng.PRNG} gen
     */
    (y: Y.Doc, gen: prng.PRNG) => { // delete text
        const ytext = y.getText('text')
 ...
 * @param {t.TestCase} tc
 */
export const testRepeatGenerateTextChanges5 = (tc: t.TestCase) => {
 ...
 * @param {t.TestCase} tc
 */
export const testRepeatGenerateTextChanges30 = (tc: t.TestCase) => {
 ...
 * @param {t.TestCase} tc
 */
export const testRepeatGenerateTextChanges40 = (tc: t.TestCase) => {
 ...
 * @param {t.TestCase} tc
 */
export const testRepeatGenerateTextChanges50 = (tc: t.TestCase) => {
 ...
 * @param {t.TestCase} tc
 */
export const testRepeatGenerateTextChanges70 = (tc: t.TestCase) => {
 ...
 * @param {t.TestCase} tc
 */
export const testRepeatGenerateTextChanges90 = (tc: t.TestCase) => {
 ...
 * @param {t.TestCase} tc
 */
export const testRepeatGenerateTextChanges300 = (tc: t.TestCase) => {
...
const qChanges: Array<((arg0: any, arg1: prng.PRNG) => void)> = [
     ...
     * @param {prng.PRNG} gen
     */
    (y: Y.Doc, gen: prng.PRNG) => { // insert embed
        const ytext = y.getText('text')
        const insertPos = prng.int32(gen, 0, ytext.length)
        if (prng.bool(gen)) {
     ...
     * @param {prng.PRNG} gen
     */
    (y: Y.Doc, gen: prng.PRNG) => { // format text
        const ytext = y.getText('text')
        const contentLen = ytext.toString().length
        const insertPos = prng.int32(gen, 0, contentLen)
        const overwrite = math.min(prng.int32(gen, 0, contentLen - insertPos), 2)
     ...
     * @param {prng.PRNG} gen
     */
    (y: Y.Doc, gen: prng.PRNG) => { // insert codeblock
        const ytext = y.getText('text')
     ...
     * @param {prng.PRNG} gen
     */
    (y: Y.Doc, gen: prng.PRNG) => { // complex delta op
        const ytext = y.getText('text')
        const contentLen = ytext.toString().length
 ...
 * @param {t.TestCase} tc
 */
export const testRepeatGenerateQuillChanges1 = (tc: t.TestCase) => {
 ...
 * @param {t.TestCase} tc
 */
export const testRepeatGenerateQuillChanges2 = (tc: t.TestCase) => {
 ...
 * @param {t.TestCase} tc
 */
export const testRepeatGenerateQuillChanges2Repeat = (tc: t.TestCase) => {
 ...
 * @param {t.TestCase} tc
 */
export const testRepeatGenerateQuillChanges3 = (tc: t.TestCase) => {
 ...
 * @param {t.TestCase} tc
 */
export const testRepeatGenerateQuillChanges30 = (tc: t.TestCase) => {
 ...
 * @param {t.TestCase} tc
 */
export const testRepeatGenerateQuillChanges40 = (tc: t.TestCase) => {
 ...
 * @param {t.TestCase} tc
 */
export const testRepeatGenerateQuillChanges70 = (tc: t.TestCase) => {
 ...
 * @param {t.TestCase} tc
 */
export const testRepeatGenerateQuillChanges100 = (tc: t.TestCase) => {
 ...
 * @param {t.TestCase} tc
 */
export const testRepeatGenerateQuillChanges300 = (tc: t.TestCase) => {
