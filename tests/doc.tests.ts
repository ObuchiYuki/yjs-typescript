 ...
 */
export const testAfterTransactionRecursion = (_tc: t.TestCase) => {
 ...
 * @param {t.TestCase} _tc
 */
export const testOriginInTransaction = (_tc: t.TestCase) => {
    const doc = new Y.Doc()
 ...
 * @param {t.TestCase} _tc
 */
export const testClientIdDuplicateChange = (_tc: t.TestCase) => {
 ...
 * @param {t.TestCase} _tc
 */
export const testGetTypeEmptyId = (_tc: t.TestCase) => {
    const doc1 = new Y.Doc()
 ...
 * @param {t.TestCase} _tc
 */
export const testToJSON = (_tc: t.TestCase) => {
    const doc = new Y.Doc()
 ...
 * @param {t.TestCase} _tc
 */
export const testSubdoc = (_tc: t.TestCase) => {
    const doc = new Y.Doc()
    doc.load() // doesn't do anything
    {
        let event: Array<any> | null = /** @type {any} */ (null)
        doc.on('subdocs', (subdocs: { added: Iterable<Y.Doc>, removed: Iterable<Y.Doc>, loaded: Iterable<Y.Doc> }) => {
            event = [
        ...
        const subdocs = doc.getMap<Y.Doc>('mysubdocs')
    ...
    const doc2 = new Y.Doc()
    {
        ...
        let event: Array<any> | null = null
        doc2.on('subdocs', (subdocs: { added: Iterable<Y.Doc>, removed: Iterable<Y.Doc>, loaded: Iterable<Y.Doc> }) => {
            event = [
        ...
        doc2.getMap<Y.Doc>('mysubdocs').get('a')?.load()
        t.compare(event, [[], [], ['a']])
 ...
 * @param {t.TestCase} _tc
 */
export const testSubdocLoadEdgeCases = (_tc: t.TestCase) => {
    const ydoc = new Y.Doc()
    const yarray = ydoc.getArray<Y.Doc>()
    ...
    const subdoc3 = ydoc2.getArray<Y.Doc>().get(0)
 ...
 * @param {t.TestCase} _tc
 */
export const testSubdocLoadEdgeCasesAutoload = (_tc: t.TestCase) => {
    const ydoc = new Y.Doc()
    const yarray = ydoc.getArray<Y.Doc>()
 ...
 * @param {t.TestCase} _tc
 */
export const testSubdocsUndo = (_tc: t.TestCase) => {
    const ydoc = new Y.Doc()
 ...
 * @param {t.TestCase} _tc
 */
export const testLoadDocsEvent = async (_tc: t.TestCase) => {
    const ydoc = new Y.Doc()
 ...
 * @param {t.TestCase} _tc
 */
export const testSyncDocsEvent = async (_tc: t.TestCase) => {
    const ydoc = new Y.Doc()
    t.assert(ydoc.isLoaded === false)
